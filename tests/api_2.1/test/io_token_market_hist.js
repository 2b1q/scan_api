...
describe('Socket.io API v. 2.1 "ERC20 token market history"', () => {
    let addr = '0x763186eb8d4856d536ed4478302971214febc6a9';
    let event = 'list';
    let payload = {
        listId: 'listOfTokenPrice',
        moduleId: 'erc20Token',
        params: {
            entityId: addr,
            size: 20,
    ...
    it(`ERC20 token market history for "${addr}" => should return market history with price > 0`, (done) => {
